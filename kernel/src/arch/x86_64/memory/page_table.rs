...
// FIXME: Try to remove these two trait which may cause multi-ref
// Notice that PageTable::new() cannot work when remove these trait
#[derive(Copy, Clone)]
...
impl PageTableEntry {
    ...
    pub fn set_address(&mut self, address: PhysAddr, flags: PageTableFlags) {
